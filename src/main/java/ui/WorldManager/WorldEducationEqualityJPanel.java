 ...
 * @author changxu
 */
public class WorldEducationEqualityJPanel extends javax.swing.JPanel {

    /**
     * Creates new form WorldEducationEqualityJPanel
     */
    ...
    public WorldEducationEqualityJPanel(JPanel userProcessContainer, UserAccount account) {
        initComponents();
    ...
    public void refreshChart(){
        ...
        String selectedItem = (String) comboIndicator.getSelectedItem();
        switch(selectedItem){
            case "Out of school" :
        ...
        JFreeChart lineChart = ChartFactory.createXYLineChart(country.getName() + " " + indicatorName + " Fluctuation", "Year", "Value",
    ...
    private void initComponents() {
        ...
        jLabel3.setText("World Education Equality");
        ...
        comboIndicator.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Out of school", "Mean years of education", "School enrollment", "Progression to higher education", "Literacy Score", "Math Score", "Science Score", " " }));
        ...
        jLabel5.setText("Select a Country:");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(comboIndicator, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private javax.swing.JComboBox<String> comboIndicator;
