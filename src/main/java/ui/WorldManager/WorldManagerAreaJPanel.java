...
import model.Role.WorldManagerRole;
 ...
 * @author changxu
 */
public class WorldManagerAreaJPanel extends javax.swing.JPanel {

    /**
     * Creates new form WorldManagerAreaJPanel
     */
    JPanel userProcessContainer;
    UserAccount account;
    Business business;
    WorldManagerRole role;
    WorldManager worldManager;
    
    public WorldManagerAreaJPanel (JPanel userProcessContainer, UserAccount account) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.account = account;
        this.business = Business.getInstance();
        this.role = (WorldManagerRole) account.getRole();
//        this.countryManager = country.getCountryManager();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("World Manager Work Area");
...
//        crdLyt.next(userProcessContainer);
    ...
    private void lblAnalyzeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAnalyzeMouseClicked
        // TODO add your handling code here:
        WorldManagerAnalyzeWorkAreaJPanel wmawajp = (WorldManagerAnalyzeWorkAreaJPanel) new WorldManagerAnalyzeWorkAreaJPanel(userProcessContainer, account);
        userProcessContainer.add("WorldManagerAnalyzeWorkAreaJPanel", wmawajp);
        CardLayout crdLyt = (CardLayout) userProcessContainer.getLayout();
        crdLyt.next(userProcessContainer);
